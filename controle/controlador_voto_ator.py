...
class ControladorVotoAtor(ControladorVoto):
    ...
    def listar_votos_em_atores(self):
        print("----- VOTOS EM ATORES -----\n")
        for voto in self.__votos_em_atores:
    ...
    def abrir_tela_voto_ator(self):
        ...
        continuar = True
        while continuar:
            opcoes[self.__tela_voto.tela_votos_em_atores()]()
